...
print("start! extraction words and bboxes from pdf.")
...
print("finish! extraction words and bboxes from pdf. ")
...
print("finish! extraction pixelvalues")
...
print("finish! create subset tokens")
